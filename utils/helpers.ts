...
/**
 * Formats a duration in minutes into a human-readable "hr/mins" string.
 *
 * Examples:
 * - 45   -> "45 mins"
 * - 60   -> "1 hr"
...
/**
 * Formats a distance for UI. Backend sends distances in miles.
 * Displays with " mi" so users do not confuse with meters ("m").
 *
 * Examples: 4 → "4 mi", 4.5 → "4.5 mi", 18.6 → "18.6 mi"
 */
