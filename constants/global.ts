...
export const SERVICES_TESTING_URLS = {
  "auth": "http://192.168.1.2:3001",
  "auction": "http://192.168.1.2:3002",
  "online-drivers": "http://192.168.1.2:3003",
  "settings": "http://192.168.1.2:3004",
  "active-trip": "http://192.168.1.2:3005",
  "notifications": "http://192.168.1.2:3006", // Notifications service on port 3006
  "me": "http://192.168.1.2:3001", // Shares with auth service
  "offers-socket": "http://192.168.1.2:3002", // Shares with auction service
  "active-trip-socket": "http://192.168.1.2:3005", // Shares with active-trip service
} as const;
